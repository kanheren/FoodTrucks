...
class ListViewControllerTest: XCTestCase {
    ...
    func testFoodTrucksCountZero() {
        ...
        XCTAssertEqual(listViewController.FoodTrucks.count, 0, "Must be 0")
    }
    func testFoodTrucksCounts() {
        ...
        let listViewController = ListViewController()
        listViewController.FoodTrucks = tempFoodTruckArray
        XCTAssertEqual(listViewController.FoodTrucks.count, 2, "Must be 0")
    }
